...
1. По ходу лабораторной работы, с помощью команды ***show spanning-tree\***, определила коммутатор на котором оказался заблокированный протоколом порт - это коммутатор S1 (рис.4) порт F0/2. Хоть порт F0/4 и имеет более высокий идентификатор, но он смотрит в сторону корневого моста, по этому протокол заблокировал порт F0/2.
...
[![img](https://github.com/wiseowl-lna/net_engineer/raw/master/labs/Lab002_STP/Trafic_s_izmeneniem_cost_18.png)](https://github.com/wiseowl-lna/net_engineer/blob/master/labs/Lab002_STP/Trafic_s_izmeneniem_cost_18.png)

1. Повторно запустила команду show ***spanning-tree\*** на коммутаторах S1 и S2.

Рис.11

[![img](https://github.com/wiseowl-lna/net_engineer/raw/master/labs/Lab002_STP/PIM_S1_18.png)](https://github.com/wiseowl-lna/net_engineer/blob/master/labs/Lab002_STP/PIM_S1_18.png)

Рис.12

[![img](https://github.com/wiseowl-lna/net_engineer/raw/master/labs/Lab002_STP/PIM_S2_18.png)](https://github.com/wiseowl-lna/net_engineer/blob/master/labs/Lab002_STP/PIM_S2_18.png)
...
1. Вернула стоимость порта F0/4 в первоначальное состояние.
...
1. С помощью команды ***no shutdown\*** включила порты F0/1 и F0/3.
...
[![img](https://github.com/wiseowl-lna/net_engineer/raw/master/labs/Lab002_STP/Trafic_no_sh_1_3.png)](https://github.com/wiseowl-lna/net_engineer/blob/master/labs/Lab002_STP/Trafic_no_sh_1_3.png)

Так же это можно увидеть с помощью команды ***show spanning-tree\***, запущенной на некорневых коммутаторах.

Рис.13

[![img](https://github.com/wiseowl-lna/net_engineer/raw/master/labs/Lab002_STP/PIM_S1_no_sh_1_3.png)](https://github.com/wiseowl-lna/net_engineer/blob/master/labs/Lab002_STP/PIM_S1_no_sh_1_3.png)

Рис.13

[![img](https://github.com/wiseowl-lna/net_engineer/raw/master/labs/Lab002_STP/PIM_S2_no_sh_1_3.png)](https://github.com/wiseowl-lna/net_engineer/blob/master/labs/Lab002_STP/PIM_S2_no_sh_1_3.png)
